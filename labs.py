...
class Labs:
    def __init__(self) -> None:
        ...
        self.user_agent: dict = {
            "User-Agent": "Ask/2.2.1/334 (iOS; iPhone) isiOSOnMac/false", "X-Client-Name": "Perplexity-iOS"}
    ...
    def _c(self, prompt: str, model: str) -> dict:
        ...
        self.ws.send("42[\"perplexity_playground\",{\"version\":\"2.1\",\"source\":\"default\",\"model\":\"" +
                     model + "\",\"messages\":" + dumps(self.history) + "}]")
